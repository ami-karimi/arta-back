        ...
        return [
            'data' => $this->collection->map(function($item){
                ...
                return [
                    ...
                    'mikrotik_server' => "not_access",
                    'mikortik_domain' => "not_access",
                    'mikrotik_port' => $item->mikrotik_port,
                    'mikrotik_username' => "not_access",
                    'mikrotik_password' => "not_access",
                    'server_type' => $item->server_type,
                    'l2tp_address' => $item->l2tp_address,
                    'server_location_id' => $item->server_location_id,
                    'password_v2ray' => "not_access",
                    'port_v2ray' => $item->port_v2ray,
                    'username_v2ray' =>  "not_access",
