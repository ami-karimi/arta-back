...
class Mikrotik
{
    ...
    var $port      = 3232;  //  Port to connect to (default 443 for https)
    var $timeout   = 3;     //  Connection attempt timeout and data read timeout
    var $min_ver   = 7.12; // mikrotik minimal version support, API is available from  v7.1beta4, but 7.7 is first really stable version.
